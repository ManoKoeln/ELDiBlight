  ...
  <!-- <div class="container"> -->
    ...
    <div class="row row-cols-12">
      ...
      <div class="col">
        ...
        <button type="button" class="btn-primary m-1 p-2 w-130 fas fa-question-circle" onclick="window.open('https://www.youtube.com/embed/jl3OQjhFEKE?autoplay=1&fs=1', '_blank', 'fullscreen=yes');"></button>
        </button>
      </div>
      <!-- <div class="col">
